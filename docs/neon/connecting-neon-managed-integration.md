> This page location: Tools & Workflows > Integrations (3rd party) > Deploy > Vercel > Neon-Managed (Connectable Account)
...
![Install on Existing Neon Account](https://neon.com/docs/guides/vercel_install_neon_modal_existing_account.png)
...
![Add Neon from Connectable Accounts](https://neon.com/docs/guides/vercel_add_connected_neon_account.png)
...
![Connect Neon Account Projects](https://neon.com/docs/guides/vercel_connect_neon_account_projects.png)
...
2. **Choose your Neon project, database, and role**
   ...
   ![Connect to Neon](https://neon.com/docs/guides/vercel_connect_neon.png)
...
![Neon branches](https://neon.com/docs/guides/vercel_neon_branches.png)
...
![Neon preview deployment branch](https://neon.com/docs/guides/vercel_deployments.png)

![Neon preview deployment branch](https://neon.com/docs/guides/vercel_neon_app_update.png)
