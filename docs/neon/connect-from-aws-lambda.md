> This page location: Tools & Workflows > Integrations (3rd party) > Serverless > AWS Lambda
...
## Related docs (Serverless)

- [Azure Functions](https://neon.com/docs/https://neon.com/guides/query-postgres-azure-functions)
