  ...
  ({ count, urgentCount, onClick, onBriefClick, isOpen = false }, ref) => {
    return (
      <button
        ...
        className="fixed bottom-10 right-10 z-[100] bg-surface-container-lowest border border-outline-variant px-6 py-3 flex items-center gap-4 shadow-[0_32px_64px_-12px_rgba(95,94,97,0.08)] hover:shadow-[0_32px_64px_-12px_rgba(95,94,97,0.15)] transition-all duration-300 active:scale-95 group"
      >
        {/* Brand Mark — click opens Daily Brief */}
